...
const STEPS = [
  { num: '01', title: 'Describe your project', desc: 'Provide a description, project type, industry, timeline, and budget.' },
  { num: '02', title: 'AI drafts each section', desc: 'Our pipeline generates 8 sections individually for maximum quality and coherence.' },
  { num: '03', title: 'Review & download', desc: 'Edit the proposal in-browser, copy it as text, or download a branded PDF.' },
];
      ...
      <div className="home">
        ...
        <section className="home__hero">
          ...
          <h1 className="home__hero-title">
            Professional project proposals,<br />
        ...
        <section className="home__sections">
          <h2 className="home__section-label">What's included in every proposal</h2>
        ...
        <section className="home__banner">
          <div className="home__banner-inner">
            <h2 className="home__banner-title">Ready to impress your next client?</h2>
            <p className="home__banner-sub">Fill in a form. Get a proposal. Download the PDF.</p>
            <Link to="/generate" className="home__hero-cta home__hero-cta--white">
              Generate Now
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                <line x1="5" y1="12" x2="19" y2="12"/>
                <polyline points="12 5 19 12 12 19"/>
